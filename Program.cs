while (true)
{
    ...
    if (number == 1) // Задача 2: два числа. Опредляет max min
    {
    ...
    if (number == 2) // Задача 4: три числа. Опредляет max
    {
        Console.Write("Введите первое число: ");
        int number1 = Convert.ToInt32(Console.ReadLine());
        Console.Write("Введите второе число: ");
    ...
    if (number == 3) //Задача 6: Четное ли число?
    {
    ...
    if (number == 4) // Задача 8: все четные числа от 1 до N
    {
        Console.Write("Введите число: ");
        int number1 = Convert.ToInt32(Console.ReadLine());
        int temp = 0;
